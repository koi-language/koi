...
export class NanoBanana2ImageGen extends BaseImageGen {
  ...
  async generate(prompt, opts = {}) {
    ...
    channel.log('image', `NanoBanana2 generate: model=${this.model}, aspect=${aspectRatio}, size=${imageSize}, quality=${quality}`);
    const _t0 = Date.now();
    ...
    try {
      ...
      channel.log('image', `NanoBanana2 generate completed in ${_elapsed}ms`);
      ...
      channel.log('image', `NanoBanana2 generate FAILED: ${err.message}`);
      throw err;
    }
  }
